...
function ArticleCard({
  article,
  to,
  /* Which slice of the photo survives the 16:9 crop. Second number is vertical — raise it
     to push the image DOWN inside the frame. Default keeps the centre, i.e. exactly what
     `object-cover` does on its own, so passing nothing changes nothing. */
  imgPosition = "center 50%",
}: { article: { title: string; chip: string; date: string; imgUrl?: string }; to: string; imgPosition?: string }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden cursor-pointer transition-all duration-200 hover:-translate-y-1 hover:shadow-lg group" style={{ border: `1px solid ${C.n200}`, backgroundColor: C.n0 }} onClick={() => navigate(to)}>
      <div className="aspect-[16/9] overflow-hidden" style={{ backgroundColor: C.n100 }}>
        {article.imgUrl ? <img src={article.imgUrl} alt={article.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" style={{ objectPosition: imgPosition }} /> : <div className="w-full h-full" style={{ backgroundColor: C.brandSoft }} />}
      </div>
      <div className="p-5">
...
/* `object-position` for the framed image in this component. Second number is the
   vertical one — raise it to push the image DOWN inside its frame. */
const LAJME_FEATURED_IMG_POSITION = "center 50%";
          ...
          <Link to="/lajme/artikull" className="block mb-12">
            <div className="grid grid-cols-1 lg:grid-cols-[58fr_42fr] gap-8 p-6 rounded-2xl hover:shadow-md transition-all" style={{ border: `1px solid ${C.n200}` }}>
              <div className="aspect-video rounded-xl overflow-hidden" style={{ backgroundColor: C.n100 }}>
                <img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=800&h=450&fit=crop&auto=format" alt="Artikulli kryesor" className="w-full h-full object-cover" style={{ objectPosition: LAJME_FEATURED_IMG_POSITION }} />
              </div>
...
/* `object-position` for the framed image in this component. Second number is the
   vertical one — raise it to push the image DOWN inside its frame. */
const ARTIKULL_HERO_IMG_POSITION = "center 50%";

/* `object-position` for the framed image in this component. Second number is the
   vertical one — raise it to push the image DOWN inside its frame. */
const ARTIKULL_BODY_IMG_POSITION = "center 50%";
    ...
    <PageWrapper>
      <div className="max-w-[1200px] mx-auto px-5 py-16">
        ...
        <div className="aspect-video rounded-2xl overflow-hidden mb-10" style={{ backgroundColor: C.n100 }}>
          <img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=1200&h=675&fit=crop&auto=format" alt="Cacttus Education" className="w-full h-full object-cover" style={{ objectPosition: ARTIKULL_HERO_IMG_POSITION }} />
        </div>
        <div className="max-w-[700px] mx-auto">
          ...
          <div className="aspect-video rounded-2xl overflow-hidden mb-3" style={{ backgroundColor: C.n100 }}>
            <img src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=700&h=394&fit=crop&auto=format" alt="Studentë" className="w-full h-full object-cover" style={{ objectPosition: ARTIKULL_BODY_IMG_POSITION }} />
          </div>
